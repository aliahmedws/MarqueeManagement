...
export class Marquees implements OnInit {
  ...
  ngOnInit(): void {
    const marqueeStreamCreator = (query) => this.marqueeService.getList({ ...query, ...this.filters });
  ...
  delete(id: string): void {
    this.confirmation.warn('ARE YOU SURE YOU WANT TO DELETE?', 'DELETE CONFIRMATION').subscribe((status) => {
